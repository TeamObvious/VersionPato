 ...
 *👋 Hola , ${taguser} Te Presento Este Hermoso Bot*

 *👑 Creador : Diana Dzn*
 *📱 Numero Creador : +5493751372455*
 *📱 Numero Spam Servicio : +5493751527973*


 *📆 Fecha:* ${date}
 *⏳ Uptime:* ${uptime}
 *🤖 Tipo de bot:* ${(conn.user.jid == global.conn.user.jid ? '' : `Sub-bot de:\n+${global.conn.user.jid.split`@`[0]}`) || '*Bot Oficial*'}
 ...
 *< PROPIETARIO Y MODS. />* 👑
 ...
 Hecho por: *‧˚꒰🩵 𝗩𝗶𝗼𝗹𝗲𝘁 𝗘𝘃𝗲𝗿𝗴𝗮𝗿𝗱𝗲𝗻 🩵꒱°‧*
 © 2024 - *‧˚꒰🩵 𝗩𝗶𝗼𝗹𝗲𝘁 𝗘𝘃𝗲𝗿𝗴𝗮𝗿𝗱𝗲𝗻 🩵꒱°‧*`.trim();
    if (m.isGroup) {
